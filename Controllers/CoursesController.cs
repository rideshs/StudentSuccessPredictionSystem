...
namespace StudentSuccessPrediction.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CourseName,CourseCode")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CourseName,CourseCode")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
